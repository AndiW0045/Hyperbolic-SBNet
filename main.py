...
def main(train_data, train_label):
    ...
    optimizer = optim.Adam(model.parameters(), lr=FLAGS.lr, weight_decay=0.0) # changed from 0.01
    ...
    for alpha in FLAGS.alpha_list:
        ...
        d_fac_per_epoch = 0
        txt_dir = 'output'
        print(FLAGS.split_type, FLAGS.save_dir, alpha)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_num_epoch', type=int, default=20, help='Max number of epochs to train, number')
    parser.add_argument('--alpha_list', type=list, default=[1], help='Alpha Values List')
    parser.add_argument('--dim_embed', type=int, default=512,
                        help='Embedding Size')
    parser.add_argument('--split_type', type=str, default='voice_only', help='split_type')
