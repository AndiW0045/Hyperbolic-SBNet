...
def test(test_feat):
    ...
    restore_path = 'fc2_random_model_alpha_1.00/checkpoint_0014_27.758.pth.tar'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dim_embed', type=int, default=512,
                        help='Embedding Size')
    parser.add_argument('--split_type', type=str, default='random', help='split_type: [hefhev, hevhef, random, vfvf, fvfv, face_only, voice_only]')
    parser.add_argument('--sh', type=str, default='seenheard', help='unseen_unheard or seen_heard')
